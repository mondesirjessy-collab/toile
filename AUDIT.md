...
### M3. [⏸️ différé v78 — RÉEL, contre-vérifié ; design ci-dessous] Cross-panel mirror exclusion applies across the entire panel interior — a flattened front/back tube interpenetrates at mirror-aligned points
**Fichier** : `src/engine/solver/shaders/selfCollide.wgsl`
